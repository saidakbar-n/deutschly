  ...
  return (
    <div className="card space-y-3">
      <div className="flex gap-2">
        <input 
          className="border rounded-lg p-3 flex-1 focus:outline-none focus:ring-2 focus:ring-indigo-500" 
      ...
      <div className="space-y-2">
        {results.map((u) => (
          <button
            key={u.id}
            className="w-full flex items-center justify-between border rounded-xl p-3 text-left hover:bg-slate-50 transition-colors"
